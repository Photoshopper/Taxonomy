...
$router->group(['prefix' =>'/taxonomy'], function (Router $router) {
    ...
    $router->get('{vocabulary_id}/terms/{term}/edit', [
    ...
    $router->delete('{vocabulary_id}/terms/{term}', [
        'as' => 'admin.taxonomy.term.destroy',
        'uses' => 'TermController@destroy',
        'middleware' => 'can:taxonomy.terms.destroy'
    ]);
    $router->post('terms/ajaxUpdate', [
        'as' => 'admin.taxonomy.term.ajaxUpdate',
        'uses' => 'TermController@ajaxUpdate'
    ]);
});
